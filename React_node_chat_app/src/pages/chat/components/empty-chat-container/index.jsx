        ...
        >
            ...
            <div className="text-opacity-80 text-white flex flex-col gap-5 items-center mt-10 lg:text-4xl text-3xl transition-all duration-100 text-center">
                <h3 className="poppins-medium">
                    ...
                    <span className="text-purple-500"> Friendzy </span> App <span className="text-purple-500">.</span>
                </h3>
                <h3 className="brawler-regular">
                    <span><span className="text-purple-400">Connect , Chat , </span>and make <span className="text-purple-400"> new friends </span>!</span>
                </h3>
            </div>
        </section>
    );
