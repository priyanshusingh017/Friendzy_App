...
export const CHANNEL_ROUTES = `${HOST}/api/channels`; // ✅ No change needed - already correct
export const CREATE_CHANNEL_ROUTE = `${CHANNEL_ROUTES}/create-channel`;
export const GET_USER_CHANNELS_ROUTE = `${CHANNEL_ROUTES}/get-user-channel`;
export const GET_CHANNEL_MESSAGES_ROUTE = `${CHANNEL_ROUTES}/get-channel-messages`; // ✅ Changed to base route without function
